...
(function(){
  ...
  // Register legacy render for debugging; do not override primary version
  window.renderSection6V2Legacy = render;

  // re-render on payment-frequency change: use primary renderSection6V2 if defined, otherwise fallback to this legacy render
  document.addEventListener('change', function(e){
    if(e.target && e.target.id === 'payment-frequency'){
      if(typeof window.renderSection6V2 === 'function') {
        try{ window.renderSection6V2(); } catch(err) { console.error(err); }
      } else {
  ...
  // Also hook into calculateAll: after calculation call the primary renderSection6V2 if available
  try{
    ...
    if(typeof origCalc === 'function'){
      window.calculateAll = function(){
        ...
        try{
          if(typeof window.renderSection6V2 === 'function') window.renderSection6V2();
          else render();
        } catch(err) {}
        return r;
      };
