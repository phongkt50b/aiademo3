...
function generateSummaryTable() {
  ...
  try {
    ...
    summaryHtml += `<th class="p-2 border">Phí đóng (quy năm)</th>`;
      ...
      summaryHtml += `<th class=\"p-2 border\">Phí đóng theo năm</th>`;if (showDiffColumn) summaryHtml += `<th class="p-2 border">Chênh lệch</th>`;
...
(() => {
  ...
  (function() {
    function customGenerateSummary() {
      ...
      summaryHtml += `<th class=\"p-2 border\">Phí đóng theo năm</th>`;if (freq !== 'year') summaryHtml += `<th class="p-2 border">Chênh lệch</th>`;
        summaryHtml += `</tr></thead><tbody>`;
